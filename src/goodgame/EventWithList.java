...
public class EventWithList {
    ...
    public static String withList(String message, Boolean canRandomize, Processor processor){
...
//            TestApp.canRandomize = false;
            ...
            Main.candy = userList.get(random.nextInt(userList.size()));
            return "{\n" +
                    "    \"type\": \"send_message\",\n" +
                    "    \"data\": {\n" +
                    "        \"channel_id\": \"" + channel.getId() + "\",\n" +
                    "        \"text\": \"" + MessageText.candyOfTheStream(candy) +
                    "        \"hideIcon\": false," +
                    "        \"mobile\": false" +
                    "    }\n" +
                    "}";
